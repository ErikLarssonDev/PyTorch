...
def main():
    train_ds = FacialKeypointDataset(
        csv_file="../facial-keypoints-detection/train_4.csv",
    ...
    val_ds = FacialKeypointDataset(
        csv_file="../facial-keypoints-detection/val_4.csv",
    ...
    #     load_checkpoint(torch.load("b0_4.pth.tar"), model, optimizer, config.LEARNING_RATE)
    #     load_checkpoint(torch.load("b0_15.pth.tar"), model, optimizer, config.LEARNING_RATE)
