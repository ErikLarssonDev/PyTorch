...
transform = Compose([transforms.Resize((448, 448)), transforms.ToTensor()]) # Could add normalization
...
def main():
    ...
    train_loader = DataLoader(dataset=train_dataset,
                              ...
                              shuffle=True,
                              drop_last=True) # If we have a batch and there is only to few examples we don't want to do an update on that
