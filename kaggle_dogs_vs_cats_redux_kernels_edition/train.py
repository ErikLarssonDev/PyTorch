...
# Idea: Use Efficientnet_b7 to extract features and then train a small model on those features
# Hopefully fast training with good performance
...
def main():
    ...
    train_dataset = CatDog(root="../dogs-vs-cats-redux-kernels-edition/train/", transform=config.basic_transform)
    test_dataset = CatDog(root="../dogs-vs-cats-redux-kernels-edition/test/", transform=config.basic_transform)
    ...
    # Fine tuning the model for 1 epoch
