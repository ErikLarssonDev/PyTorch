...
def main():
    train_ds = DRDataset(
        images_folder="../diabetic-retinopathy-detection/train_images_preprocessed_1000/",
        path_to_csv="../diabetic-retinopathy-detection/train_labels.csv",
        transform=config.val_transforms,
    )
    val_ds = DRDataset(
        images_folder="../diabetic-retinopathy-detection/train_images_preprocessed_1000/",
        path_to_csv="../diabetic-retinopathy-detection/val_labels.csv",
        transform=config.val_transforms,
    )
    test_ds = DRDataset(
        images_folder="../diabetic-retinopathy-detection/test_images_preprocessed_1000/",
        path_to_csv="../diabetic-retinopathy-detection/train_labels.csv",
        transform=config.val_transforms,
        train=False,
    )
    ...
    get_csv_for_blend(val_loader, model, "../diabetic-retinopathy-detection/val_blend.csv")
    get_csv_for_blend(train_loader, model, "../diabetic-retinopathy-detection/train_blend.csv")
    get_csv_for_blend(test_loader, model, "../diabetic-retinopathy-detection/test_blend.csv")
