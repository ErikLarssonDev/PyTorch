...
class NN(nn.Module):
    def __init__(self, input_size, hidden_dim):
        ...
        self.fc1 = nn.Linear(2, hidden_dim) # Embedding features
    ...
    def forward(self, x):
        ...
        x = torch.cat([original_features, new_features], dim=2) # (N, 200, 2)
...
get_submission(model, test_loader, test_ids, DEVICE) # 0.92
